...
declare global {
    namespace squared.lib {
        ...
        namespace dom {
            ...
            export function getFirstChildElement(elements: Element, lineBreak?: boolean): Element | null;
            export function getLastChildElement(elements: Element, lineBreak?: boolean): Element | null;
