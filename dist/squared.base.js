...
this.squared.base = (function (exports) {
    ...
    const { allSettled, capitalize: capitalize$2, convertCamelCase: convertCamelCase$2, isBase64: isBase64$1, isEmptyString: isEmptyString$1, resolvePath: resolvePath$1, splitPair: splitPair$4, startsWith: startsWith$9 } = squared.lib.util;
            ...
            switch (item.type) {
                case CSSRule.STYLE_RULE: {
                    ...
                    for (let i = 0, length = cssStyle.length; i < length; ++i) {
                        ...
                        if (value === 'initial') {
                            const property = CSS_PROPERTIES$4[baseAttr];
                            if (property) {
                            ...
                            if (property) {
                                for (const subAttr of property.value) {
                                    const valueOfNone = CSS_PROPERTIES$4[subAttr].valueOfNone;
                                    if (valueOfNone) {
                    ...
                    if (cssText.includes('!')) {
                        ...
                        while (match = REGEXP_IMPORTANT.exec(cssText)) {
                            ...
                            if ((property = CSS_PROPERTIES$4[attr]) && Array.isArray(property.value)) {
            ...
            for (let i = 0, length = pseudoList.length; i < length; ++i) {
                ...
                switch (pseudo) {
                    ...
                    case ':empty': {
                        ...
                        if (childNodes.length && iterateArray$3(childNodes, item => item.nodeName[0] !== '#' || item.nodeName === '#text') === Infinity) {
                            return false;
                        }
                        break;
                    }
    ...
    class Node extends squared.lib.base.Container {
        ...
        parseUnit(value, options) {
            if (!value) {
                ...
                return convertPercent$3(value) * this.getContainerSize(options);
            }
            if (!options) {
        ...
        get hasHeight() {
            ...
            return result === undefined ? this._cache.hasHeight = isPercent$4(this.valueOf('height')) ? this.pageFlow ? ((_a = this.actualParent) === null || _a === void 0 ? void 0 : _a.hasHeight) || this.documentBody : this.positionFixed || this.hasPX('top') || this.hasPX('bottom') : this.height > 0 || this.hasPX('height', { percent: false }) : result;
        }
        get lineHeight() {
        ...
        get percentHeight() {
            ...
            if (result === undefined) {
                ...
                return this._cache.percentHeight = isPercent$4(value) && (((_a = this.absoluteParent) === null || _a === void 0 ? void 0 : _a.hasHeight) || this.positionFixed) ? convertPercent$3(value) : 0;
            }
            return result;
        }
        get visibleStyle() {
    ...
    const { convertBase64, convertCamelCase, convertPercent: convertPercent$2, escapePattern, hasValue, isEqual, isNumber: isNumber$2, isString: isString$1, iterateArray: iterateArray$2, lastItemOf, splitPair, startsWith: startsWith$4 } = squared.lib.util;
