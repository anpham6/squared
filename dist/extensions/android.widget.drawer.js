...
this.android.widget.drawer = (function () {
    ...
    class Drawer extends squared.base.ExtensionUI {
        ...
        processNode(node, parent) {
            ...
            if (
                Drawer.findNestedElement(node, "android.widget.menu" /* MENU */)
            ) {
                assignEmptyValue(
                    options,
                    "android",
                ...
                const navigationViewOptions = createViewAttribute(
                ...
                assignEmptyValue(
                    ...
                    "android",
                    "layout_gravity",
                    node.localizeString("left")
                );
                const navView = node.item();
                navView.mergeGravity(
                    "layout_gravity",
                    navigationViewOptions.android.layout_gravity
                );
            ...
            const controlName =
                node.api < 29 /* Q */
                    ? SUPPORT_ANDROID.DRAWER
                    : SUPPORT_ANDROID_X.DRAWER;
        ...
        afterParseDocument() {
            ...
            for (const node of this.subscribers) {
                ...
                const headerLayout =
                    (_b = Drawer.findNestedElement(
                        node,
                        EXT_ANDROID.EXTERNAL
                    )) === null || _b === void 0
                        ? void 0
        ...
        postOptimize(node) {
            const element = Drawer.findNestedElement(
                node,
            ...
            if (element) {
                ...
                if (
                    (coordinator === null || coordinator === void 0
                        ? void 0
                        : coordinator.inlineHeight) &&
