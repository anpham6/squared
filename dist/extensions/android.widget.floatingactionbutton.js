/* android.widget.floatingactionbutton 1.8.0
...
this.android.widget.floatingactionbutton = (function () {
    ...
    class FloatingActionButton extends squared.base.ExtensionUI {
        is(node) {
            ...
            return (
                ...
                (element.tagName !== "INPUT" ||
                    SUPPORTED_INPUT.includes(element.type))
            );
        }
        condition(node) {
        ...
        processNode(node, parent) {
            ...
            const colorName = Resource.addColor(
                parseColor(
                    node.css("backgroundColor"),
                    node.toFloat("opacity", 1)
                )
            );
            assignEmptyValue(
                options,
            ...
            if (!node.pageFlow) {
                ...
                const offsetParent =
                    this.application.resolveTarget(target) || parent;
                if (leftRight) {
